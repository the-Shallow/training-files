...
void cal( int sub1,int sub2,int sub3,int sub4 ,int sub5){

	int aggragate_sum = sub1 + sub2 + sub3 + sub4 + sub5;
	float perc_sub1 = (float)( (sub1 * 100 ) / 500.00);
	float perc_sub2 = (float)(( sub2 * 100 ) / 500.00);
	float perc_sub3 = (float)(( sub3 * 100 ) / 500.00);
	float perc_sub4 = (float)(( sub4 * 100 ) / 500.00);
	float perc_sub5 = (float)(( sub5 * 100 ) / 500.00);
	printf("\n--------------------------\n");
